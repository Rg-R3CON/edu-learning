        ...
        <div class="header-bottom">
            <div class="container">
              ...
              <?php  if($this->session->userdata('uid')):          ?> 
                        <a href="<?php echo base_url();?>IndiaExcels/users_dashboard">
                        <!-- C:\xampp\htdocs\india_excels\assets\user\images\logo\logo.png -->
                            <img src=" <?php echo base_url('assets/user/images/logo/logo.png');?>" alt="logo"  style="height:80px;width:140px;">
                        </a>
             <?php else: ?>
                        
<a href="<?php echo base_url();?>IndiaExcels/index">
                        <!-- C:\xampp\htdocs\india_excels\assets\user\images\logo\logo.png -->
                            <img src=" <?php echo base_url('assets/user/images/logo/logo.png');?>" alt="logo"  style="height:80px;width:140px;">
                        </a>
...
<?php else:?>
                           ...
                           <li>
                                <a href="<?php echo base_url();?>IndiaExcels/about">ABOUT</a>
                                    ...
                                    <li>
                                <a href="<?php echo base_url();?>IndiaExcels/howitwork">HOW IT WORK</a>
                            </li>
                            <li>              
